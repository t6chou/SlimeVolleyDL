...
# PPO learns to play the game from scratch, then saves the best
# versions of itself to improve the challenge over time
# See TRAINING.md for full analysis
...
# Settings
SEED = 17
NUM_TIMESTEPS = int(1e9) #was 1e9
EVAL_FREQ = int(1e5) # was 1e5
EVAL_EPISODES = int(1e2) # was 1e2
...
def train():
  ...
  # trying to create tensorboard info
